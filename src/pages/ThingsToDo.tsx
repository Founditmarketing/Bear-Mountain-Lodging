...
const categories: Category[] = [
  {
    ...
    items: [
      { name: "Beaver's Bend Mining Company",       url: 'https://beaversbendminingcompany.com',                                                              image: `${BASE}/2022/05/Untitled-design-20.png` },
      { name: 'Beavers Bend Safari Park',            url: 'https://beaversbendsafaripark.com/',                                                                 image: `${BASE}/2025/04/Screenshot-2025-04-25-at-9.41.15 AM.png` },
      ...
      { name: 'Broken Bow Balloon Rides',            url: 'https://www.facebook.com/Broken-Bow-Balloon-Rides-106425755454152/',                                 image: `${BASE}/2022/10/Untitled-design-24.png` },
      ...
      { name: "Hester's Theater of Magic",           url: 'https://www.hestermagic.com/',                                                                       image: `${BASE}/2025/04/Screenshot-2025-04-25-at-9.39.48 AM.png` },
      ...
      { name: 'Rugaru Adventures–Zip Line Tours',    url: 'https://rugaruadventures.com',                                                                       image: `${BASE}/2022/05/Untitled-design-10-1.png` },
      ...
      { name: 'The Cave Virtual Reality',            url: 'https://www.thecavevr.com/',                                                                         image: `${BASE}/2025/04/Screenshot-2025-04-25-at-9.42.02 AM.png` },
