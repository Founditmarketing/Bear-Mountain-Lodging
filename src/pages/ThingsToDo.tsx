...
const categories: Category[] = [
  {
    ...
    items: [
      { name: "Beaver's Bend Mining Company", url: 'https://beaversbendminingcompany.com', image: `${BASE}/2022/05/Untitled-design-7.png` },
      { name: 'Beavers Bend Safari Park', url: 'https://beaversbendsafaripark.com/', image: `${BASE}/2022/05/Untitled-design-8-1.png` },
      { name: 'Beavers Bend Wildlife Museum', url: 'http://www.pine-net.com/nature/', image: `${BASE}/2022/05/Untitled-design-8.png` },
      { name: 'Bigfoot Axe Throwing', url: 'https://www.hochatownescapegames.com/hochatown-bigfoot-axe-throwing/', image: `${BASE}/2022/05/Untitled-design-9-1.png` },
      { name: 'Broken Bow Balloon Rides', url: 'https://www.facebook.com/Broken-Bow-Balloon-Rides-106425755454152/', image: `${BASE}/2022/05/Untitled-design-9.png` },
      { name: 'Broken Bow Lake Tiki Boat Tours', url: 'https://thebrokentiki.com', image: `${BASE}/2022/05/Untitled-design-7-2.png` },
      { name: 'Crag Climb Indoor Boulder Gym', url: 'https://www.cragclimbbeaversbend.com', image: `${BASE}/2022/05/Untitled-design-10-2.png` },
      { name: 'Forest Heritage Center Museum', url: 'https://forestry.ok.gov/fhc', image: `${BASE}/2022/05/Untitled-design-8-2.png` },
      { name: 'Gutter Chaos Bowling', url: 'https://www.facebook.com/Gutter-Chaos-113320113867837/', image: `${BASE}/2022/05/Untitled-design-11-2.png` },
      { name: "Hester's Theater of Magic", url: 'https://www.hestermagic.com/', image: `${BASE}/2022/05/Untitled-design-12-2.png` },
      { name: 'Hochatown Escape Games', url: 'https://www.hochatownescapegames.com', image: `${BASE}/2022/05/Untitled-design-13-2.png` },
      { name: 'Hochatown Petting Zoo', url: 'https://www.facebook.com/HochatownPettingZoo/', image: `${BASE}/2022/05/Untitled-design-14-2.png` },
      { name: 'Hydrafly Watersports', url: 'https://www.facebook.com/HydraFly-Watersports-Broken-Bow-Lake-Hochatown-OK-436503757182193/', image: `${BASE}/2022/05/Untitled-design-15-2.png` },
      { name: 'McCurtain Cinema', url: 'https://www.mccurtaincinema.com', image: `${BASE}/2022/05/Untitled-design-16-2.png` },
      { name: 'Rugaru Adventures–Zip Line Tours', url: 'https://rugaruadventures.com', image: `${BASE}/2022/05/Untitled-design-7.png` },
      { name: 'Semper Fly Helicopter Tours', url: 'https://www.facebook.com/semperflyhelicopters/', image: `${BASE}/2022/05/Untitled-design-3.png` },
      { name: 'The Gallery Paint & Chardonnay', url: 'https://www.paintandchardonnay.com', image: `${BASE}/2022/05/Untitled-design-8-1.png` },
      { name: 'The Cave Virtual Reality', url: 'https://www.thecavevr.com/', image: `${BASE}/2022/05/Untitled-design-9-1.png` },
      { name: 'The Maze of Hochatown', url: 'https://www.facebook.com/TheMazeofHochatown/', image: `${BASE}/2022/05/Untitled-design-16-2.png` },
      { name: "Thomahawk's Axe Throwing", url: 'https://throwthataxe.com', image: `${BASE}/2022/05/Untitled-design.jpg` },
    ],
  },
  {
    id: 'atv',
