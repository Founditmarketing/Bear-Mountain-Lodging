...
const categories: Category[] = [
  ...
  },
  {
    ...
    label: 'Casinos',
    icon: Sparkles,
    heroImage: '/images/things-to-do/choctaw-casino.png',
    items: [
      { name: 'Choctaw Casino Broken Bow', url: 'https://www.choctawcasinos.com/broken-bow/', image: '/images/things-to-do/choctaw-casino.png' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Beavers Bend Restaurant', url: 'https://www.facebook.com/pages/category/American-Restaurant/Beavers-Bend-Restaurant-227189594369420/', image: '/images/things-to-do/beavers-bend-restaurant.png' },
      ...
      { name: 'Mountain Fork Brewery & Restaurant', url: 'https://www.mtforkbrewery.com/home', image: '/images/things-to-do/mountain-fork-brewery.png' },
      ...
      { name: "Phat Tabb's BBQ", url: 'https://phattabbsbbq.com/', image: '/images/things-to-do/phat-tabbs-bbq.png' },
      { name: 'Pressa', url: 'https://www.pressaitalia.com/', image: `${BASE}/2022/05/Untitled-design-20-1.png` },
      { name: 'Rock Bottom Boyz BBQ', url: 'https://www.facebook.com/Rock-Bottom-Boyz-BBQ-660351367451143/', image: '/images/things-to-do/rock-bottom-bbq.png' },
      { name: 'Rogue Local', url: 'https://roguelocalgrill.com/', image: '/images/things-to-do/rogue-local.png' },
      ...
      { name: 'The Oaks Steakhouse', url: 'https://theoakssteakhouse.com/', image: '/images/things-to-do/oaks-steakhouse.png' },
